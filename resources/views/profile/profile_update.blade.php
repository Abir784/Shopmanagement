                        ...
                        <div class="profile-head">
                            <div class="photo-content">
                                <div class="cover-photo">
                                    <img src="{{asset('uploads/admin')}}/{{Auth::user()->profile_image}}" alt="" srcset="" width="100%" height="450">
                                </div>
                            </div>
                            ...
                            <div class="profile-tab">
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs">
                                        {{-- <li class="nav-item"><a href="#my-posts" data-toggle="tab" class="nav-link active show"></a>
                                        </li> --}}
                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                <p>
                                                    ...
                                                    you can change account settings and see your personal sells report here.
                                        ...
                                        <div id="about-me" class="tab-pane fade">
                                            <div class="profile-about-me">
                                                <div class="pt-4 border-bottom-1 pb-3">
                                                    ...
                                                    <p class="mb-2"><p>Hello, I am <b>{{Auth::user()->name}}</b>, my email address is
                                                        <b>{{Auth::user()->email}}</b>

                                                    </p>

                                                    <p>
                                                        I hereby myself devoted to my assigned work and obidient to my superiors.<br>
                                                         I promise to be loyal towards the institute.
                                                    </p>
                                            ...
                                            <div class="profile-personal-info">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-sm-9 col-7">
                                                        @if (App\Models\AdminDetails::where('admin_id',Auth::id())->exists())
                                                        <span>{{App\Models\AdminDetails::where('admin_id',Auth::id())->first()->address}}</span>
                                                        @else
