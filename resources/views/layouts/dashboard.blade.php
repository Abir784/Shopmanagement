                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{asset('uploads/admin')}}/{{Auth::user()->profile_image}}" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href='{{route('profile.update',Auth::id())}}' class="dropdown-item ai-icon">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('form.product')}}"> Add Products </a></li>
...
<br><br><br><br>
				<div class="copyright">
					<p><strong>Afroza International</p>
                    <p></strong> ©All Rights Reserved</p>

					<p>Made with <span class="heart"></span> by Abir</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="" target="_blank">Abir</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
